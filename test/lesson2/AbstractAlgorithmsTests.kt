...
abstract class AbstractAlgorithmsTests {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("", longestCommonSubstring("я", ""))
        assertEquals("", longestCommonSubstring("я", "y"))
        assertEquals(" дом", longestCommonSubstring(" дом из кирпича", "в доме кирка"))
...
Но вреден север для меня
    ...
    fun calcPrimesNumber(calcPrimesNumber: (Int) -> Int) {
        ...
        assertEquals(30, calcPrimesNumber(123))
        assertEquals(54, calcPrimesNumber(256))
        assertEquals(74, calcPrimesNumber(373))
